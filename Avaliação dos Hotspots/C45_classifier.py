...
import os
import pyRAPL
from mlfromscratch.utils import train_test_split, standardize, accuracy_score, calculate_entropy
from mlfromscratch.utils import mean_squared_error, calculate_variance, Plot, divide_on_feature

pyRAPL.setup()
csv_output=pyRAPL.outputs.CSVOutput('Hotspots_DT_c45_classifier.csv')
