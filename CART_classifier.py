...
import pyRAPL
pyRAPL.setup()
csv_output=pyRAPL.outputs.CSVOutput('Hotspots_DT_classifier_CART.csv')


class CART(object):
    def __init__(self, tree = 'cls', criterion = 'gini', prune = 'depth', max_depth = 16, min_criterion = 0.05):
        self.feature = None
        self.label = None
        self.n_samples = None
        self.gain = None
